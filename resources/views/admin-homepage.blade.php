...
<head>
    ...
    <title>CETL Admin Homepage</title>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div>Checkouts Returning Today!</div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> New Users Chart</h3>
                            </div>
                                ...
                                <script>
                                    Morris.Line({
                                      ...
                                      data: [{
                                          ...
                                          visits: <?php echo $thirtyDayAgoCount?>
                                      },],
